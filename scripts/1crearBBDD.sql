...
-- CREATE DATABASE `if0_38343594_joritz` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `dwes`;
...
-- CREATE USER `if0_38343594`
-- IDENTIFIED BY 'XrjGX8S4tW3';

-- GRANT ALL ON `if0_38343594_joritz`.*
-- TO `if0_38343594`;